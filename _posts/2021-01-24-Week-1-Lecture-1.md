...
Check the following page for several examples of specific <a target="_parent" href="https://https://wcasper.github.io/math107spring2021/extras/example-problems">cool problems that can be solved using linear algebra (link)</a>.
